...
# About:  Automation Script to Create log file of the running processes and send 
#         mail attaching log file by checking internet connection.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
def main():
	...
	schedule.every(int(argv[1])).hour.do(Create_LogFile)
